...
export enum ErrorCode {
  ...
  // Human-readable error codes (RC1)
  PAYPAL_NOT_CONFIGURED = 'PAYPAL_NOT_CONFIGURED',
  EBAY_AUTH_REQUIRED = 'EBAY_AUTH_REQUIRED',
  ALIEXPRESS_REAUTH_REQUIRED = 'ALIEXPRESS_REAUTH_REQUIRED',
  INSUFFICIENT_MARGIN = 'INSUFFICIENT_MARGIN',
  AFFILIATE_PERMISSION_MISSING = 'AFFILIATE_PERMISSION_MISSING',
  MAX_DAILY_LIMIT_REACHED = 'MAX_DAILY_LIMIT_REACHED',
}

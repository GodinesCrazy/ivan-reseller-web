...
const cjEbayNavGroup: NavGroup = {
  ...
  items: [
    ...
    { path: '/cj-ebay/discover', label: 'Descubrir', icon: Search },
    { path: '/cj-ebay/products', label: 'Productos CJ', icon: Package },
    { path: '/cj-ebay/listings', label: 'Listings eBay', icon: List },
    { path: '/cj-ebay/orders', label: 'Órdenes', icon: Truck },
    { path: '/cj-ebay/post-sale', label: 'Post Venta', icon: Receipt },
    { path: '/cj-ebay/alerts', label: 'Alertas', icon: Bell },
    { path: '/cj-ebay/profit', label: 'Profit', icon: LineChart },
    { path: '/cj-ebay/analytics', label: 'Analítica', icon: Activity },
    { path: '/cj-ebay/sales-agent', label: 'Agente eBay', icon: Bot },
    { path: '/cj-ebay/store-optimizer', label: 'Optimizador Tienda', icon: SlidersHorizontal },
    { path: '/cj-ebay/automation', label: 'Automatización', icon: Zap },
    { path: '/cj-ebay/settings', label: 'Configuración', icon: SlidersHorizontal },
...
const cjShopifyUsaNavGroup: NavGroup = {
  ...
  items: [
    ...
    { path: '/cj-shopify-usa/post-sale', label: 'Post Venta', icon: Receipt },
    ...
    { path: '/cj-shopify-usa/sales-agent', label: 'Agente Vendedor', icon: Bot },

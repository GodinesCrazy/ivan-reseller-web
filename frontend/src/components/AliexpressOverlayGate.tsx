/**
 * Overlay desmontable cuando AliExpress requiere sesi�n manual.
...
export default function AliexpressOverlayGate() {
  ...
  // Solo mostrar overlay si hay sesi�n manual ACTIVA pendiente (token), no por requiresManual gen�rico
  ...
  // Auto-dismiss si no hay sesi�n manual activa (evitar overlay bloqueante por estado antiguo)
  useEffect(() => {
    ...
    >
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-md w-full overflow-hidden border-2 border-red-200 dark:border-red-800">
        <div className="bg-red-600 text-white px-6 py-4">
          ...
          <p className="text-red-100 text-sm mt-1">Acci�n requerida</p>
        </div>
        <div className="p-6 space-y-4">
          <p className="text-gray-700 dark:text-gray-300">
            Sesi�n manual requerida para completar el login en AliExpress. Puedes configurarlo ahora
            o continuar usando el dashboard y hacerlo m�s tarde.
          </p>
